namespace HomeAccountingSystem_DAL.Migrations
{
    ...
    public partial class CreateDatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.PaiyngItemProduct",
                c => new
                    {
                        ItemID = c.Int(nullable: false, identity: true),
                        ProductID = c.Int(nullable: false),
                        Summ = c.Decimal(nullable: false, precision: 19, scale: 4),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PaiyngItemProduct", "PayingItemID", "dbo.PayingItem");
            DropForeignKey("dbo.PaiyngItemProduct", "ProductID", "dbo.Product");
            ...
            DropIndex("dbo.PaiyngItemProduct", new[] { "PayingItemID" });
            DropIndex("dbo.PaiyngItemProduct", new[] { "ProductID" });
            ...
            DropTable("dbo.PaiyngItemProduct");
