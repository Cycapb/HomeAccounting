...
namespace WebUI.Tests.HelpersTests
{
    ...
    public class PayingItemEditViewModelCreatorTests
    {
        ...
        public async Task CreateViewModel_PayingItemIsNull_ReturnsNullViewModel()
        {
        ...
        [TestMethod]
        [TestCategory("PayingItemEditViewModelCreatorTests")]
        public async Task CreateViewModel_PayingItemContainsNoProducts_CategoryContainsFreeProducts()
        {
        ...
        [TestMethod]
        [TestCategory("PayingItemEditViewModelCreatorTests")]
        public async Task CreateViewModel_PayingItemContainsProducts_CategoryContainsNoFreeProducts()
        {
            var payingItem = new PayingItem()
            {
                Category = new Category()
        ...
        [TestMethod]
        [TestCategory("PayingItemEditViewModelCreatorTests")]
        public async Task CreateViewModel_PayingItemContainsProducts_CategoryContainsFreeProducts()
        {
            var payingItem = new PayingItem()
            {
                Category = new Category()
        ...
        [TestMethod]
        [TestCategory("PayingItemEditViewModelCreatorTests")]
        public async Task CreateViewModel_PayingItemContainsNoProducts_CategoryContainsNoProducts()
        {
            var payingItem = new PayingItem()
            {
                Category = new Category()
        ...
        [TestMethod]
        [TestCategory("PayingItemEditViewModelCreatorTests")]
        public async Task CreateViewModel_PayingItemContainsAllProductsFromCategory()
        {
            var payingItem = new PayingItem()
            {
                Category = new Category()
        ...
        [TestMethod]
        [TestCategory("PayingItemEditViewModelCreatorTests")]
        public async Task CreateViewModel_ThrowsWebUiExceptionWithInnerServiceException()
        {
        ...
        [TestMethod]
        [TestCategory("PayingItemEditViewModelCreatorTests")]
        public async Task CreateViewModel_ThrowsWebUiExceptionWithInneException()
        {
            _payingItemServiceMock.Setup(x => x.GetItemAsync(It.IsAny<int>())).Throws<ServiceException>();
            var target = new PayingItemEditViewModelCreator(_payingItemServiceMock.Object);
